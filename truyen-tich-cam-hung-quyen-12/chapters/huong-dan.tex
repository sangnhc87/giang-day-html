...
\smallskip
\textbf{\color{inkbrown}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{teacherblue}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{teacherblue!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{chalkgold!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
