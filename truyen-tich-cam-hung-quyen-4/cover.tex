...
\begin{titlepage}
\thispagestyle{empty}
\pagecolor{truyenblue!8}

\begin{tikzpicture}[remember picture, overlay]
  \fill[white, opacity=0.55, rounded corners=20pt]
...
\begin{center}
  ...
  {\fontsize{14}{16}\selectfont\color{truyenblue!80!black}\scshape
   \textbf{Triết Lý Nhân Sinh \& Đối Nhân Xử Thế}}\\[1.5cm]
  ...
  {\fontsize{18}{22}\selectfont\color{truyengold!90!black}\itshape
    Câu Chuyện Từ Cổ Chí Kim Đến Hiện Đại}\\[1cm]
  ...
  {\normalsize\itshape\color{truyenblue!90!black}
   ``Sống không phải là để tồn tại mà để ý nghĩa ---\\
   \textit{(Life is not to merely exist but to be meaningful ---)}\\[0.2cm]
   Mỗi câu chuyện là một ngọn đèn soi đường.''\\
   \textit{(Each story is a lamp lighting the way.)}''%
  }
