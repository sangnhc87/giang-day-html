...
\begin{center}
  ...
  {\fontsize{18}{22}\selectfont\color{truyengold!90!black}\itshape
    Bài Học Từ Cổ Chí Kim Đến Hiện Đại}\\[1cm]
  ...
  {\normalsize\itshape\color{truyenblue!90!black}
   ``Đối nhân xử thế không phải là nghệ thuật ---\\
   \textit{(Dealing with people is not merely an art ---)}\\[0.2cm]
   mà là triết lý sâu sắc của trái tim.''\\
   \textit{(but a deep philosophy of the heart.)}''}
