...
Bộ sách <<Truyện Tích Cảm Hứng Song Ngữ>> gồm 28 quyển, mỗi quyển một chủ đề riêng. Quyển XXII này mang chủ đề: \textbf{nâng đỡ, động viên, mở lối~--- không la mắng}.
\textit{(The series ``Inspiring Bilingual Tales'' contains 28 volumes, each with its own theme. Volume XXII focuses on: \textbf{nâng đỡ, động viên, mở lối~--- không la mắng}.})
\end{truyen}
