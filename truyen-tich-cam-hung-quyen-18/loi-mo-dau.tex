...
Quyển này nay được mở rộng thành 80 câu, chia làm tám nhóm: về việc học, về nỗ lực, về thái độ sống, về sai lầm, về tương lai, về kỷ luật, về tự học, và về nhân cách. Mỗi câu đi kèm một câu chuyện nhỏ, để thầy cô có thể dùng khi mở bài, kết tiết, viết bảng, hoặc tặng học sinh cuối năm.
\textit{(This volume is now expanded to 80 sentences in eight groups: on learning, effort, attitude, mistakes, the future, discipline, self-learning, and character. Each is paired with a short story, so teachers can use them to open a lesson, close a class, write on the board, or give to students at year's end.)}
