...
Bộ sách <<Truyện Tích Cảm Hứng Song Ngữ>> gồm 24 quyển, mỗi quyển một chủ đề riêng. Quyển VII này mang chủ đề: \textbf{triết lý từ bậc thầy qua các thời đại Đông~-- Tây}.
\textit{(The series ``Inspiring Bilingual Tales'' contains 24 volumes, each with its own theme. Volume VII focuses on: \textbf{triết lý từ bậc thầy qua các thời đại Đông~-- Tây}.})
\end{truyen}
