...
\begin{tcolorbox}[
  colback=accentsgold!8,
  colframe=accentsgold!70!black,
  coltitle=black,
  fonttitle=\bfseries,
...
\smallskip
\textbf{\color{inkdark}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{darkred}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{darkred!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{accentsgold!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
