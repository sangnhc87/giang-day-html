...
\begin{center}
{\large\bfseries\color{trapbrown} CÁC QUYỂN TRONG BỘ SÁCH}\\[4pt]
{\normalsize\itshape\color{trapgreen} Truyện Tích Cảm Hứng Song Ngữ}\\[8pt]
{\color{trapgold}\rule{10cm}{1.5pt}}
\end{center}
...
\vspace{6pt}
\begin{center}
{\color{trapgold}\rule{10cm}{1.5pt}}\\[4pt]
{\small\itshape\color{trapgreen!70} Bộ sách song ngữ Việt -- Anh dành cho giáo viên và học sinh}
\end{center}
\clearpage
