...
\medskip
\textbf{\color{edugreen}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{edugreen!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{honeygold!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
