...
\begin{center}
{\large\bfseries\color{warmbrown} CÁC QUYỂN TRONG BỘ SÁCH}\\[4pt]
{\normalsize\itshape\color{oliveink} Truyện Tích Cảm Hứng Song Ngữ}\\[8pt]
{\color{papergold}\rule{10cm}{1.5pt}}
\end{center}
...
\vspace{6pt}
\begin{center}
{\color{papergold}\rule{10cm}{1.5pt}}\\[4pt]
{\small\itshape\color{oliveink!70} Bộ sách song ngữ Việt -- Anh dành cho giáo viên và học sinh}
\end{center}
\clearpage
