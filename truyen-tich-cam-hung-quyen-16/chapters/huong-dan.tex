...
\smallskip
\textbf{\color{slateink}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{brickred}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{brickred!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{dustgold!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
