...
\smallskip
\textbf{\color{deepbrown}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{nightblue}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{nightblue!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{lamporange!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
