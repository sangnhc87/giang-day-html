...
\begin{center}
{\large\bfseries\color{earthink} CÁC QUYỂN TRONG BỘ SÁCH}\\[4pt]
{\normalsize\itshape\color{deepblue} Truyện Tích Cảm Hứng Song Ngữ}\\[8pt]
{\color{softcopper}\rule{10cm}{1.5pt}}
\end{center}
...
\vspace{6pt}
\begin{center}
{\color{softcopper}\rule{10cm}{1.5pt}}\\[4pt]
{\small\itshape\color{deepblue!70} Bộ sách song ngữ Việt -- Anh dành cho giáo viên và học sinh}
\end{center}
\clearpage
