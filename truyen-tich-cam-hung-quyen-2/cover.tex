...
\begin{center}
  ...
  {\fontsize{14}{16}\selectfont\color{truyenblue!80!black}\scshape \textbf{Học Cách Làm Người}}\\[1.5cm]
  ...
  {\fontsize{18}{22}\selectfont\color{truyengold!90!black}\itshape
    Tuyển Tập Đạo Làm Người \& Đối Nhân Xử Thế}\\[1cm]
  ...
  {\normalsize\itshape\color{truyenblue!90!black}
   ``Mỗi câu chuyện là một tấm gương — hãy nhìn vào để thấy mình.\\
   Những trang sách nhỏ, chứa đựng cả đạo làm người.''}
