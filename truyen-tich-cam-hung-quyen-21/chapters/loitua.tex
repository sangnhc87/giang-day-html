...
\begin{truyen}{Lời Tựa}{60 Wake-Up Calls for the Reluctant Student}
...
Quyển hai mươi mốt nay được mở rộng thành 60 câu như thế: thẳng, rõ, để học sinh tỉnh ra trước khi trả giá bằng điểm kém, bằng cơ hội mất, bằng hối tiếc sau này. Mong thầy cô dùng đúng lúc; mong học trò đọc khi còn kịp.
\textit{(Volume twenty-one is now expanded to 60 such sentences: direct and clear, so students wake up before paying with bad grades, lost chances, and future regret. May teachers use them at the right moment; may students read them while there is still time.)}

Bộ sách <<Truyện Tích Cảm Hứng Song Ngữ>> gồm 28 quyển, mỗi quyển một chủ đề riêng. Quyển XXI này mang chủ đề: \textbf{thẳng, rõ, để tỉnh ra trước khi trả giá}.
\textit{(The series ``Inspiring Bilingual Tales'' contains 28 volumes, each with its own theme. Volume XXI focuses on: \textbf{thẳng, rõ, để tỉnh ra trước khi trả giá}.})
\end{truyen}
...
\begin{tuhocnhanh}
1. Câu nào trong 60 câu này khiến em giật mình nhất? Vì sao? \textit{(Which of the 60 sentences gave you the biggest wake-up? Why?)}
