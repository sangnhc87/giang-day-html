...
\smallskip
\textbf{\color{warmbrown}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{oliveink}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{oliveink!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{papergold!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
