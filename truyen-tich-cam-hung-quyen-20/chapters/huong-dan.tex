...
\medskip
\textbf{\color{warmorange}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{warmorange!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{teal!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
