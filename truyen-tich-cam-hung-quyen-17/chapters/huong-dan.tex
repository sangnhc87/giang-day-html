...
\smallskip
\textbf{\color{inkgray}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{mossgreen}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{mossgreen!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{warmgold!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
