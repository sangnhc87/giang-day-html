...
\begin{center}
{\large\bfseries\color{inkbrown} CÁC QUYỂN TRONG BỘ SÁCH}\\[4pt]
{\normalsize\itshape\color{teacherblue} Truyện Tích Cảm Hứng Song Ngữ}\\[8pt]
{\color{chalkgold}\rule{10cm}{1.5pt}}
\end{center}
...
% === 9 QUYỂN SAU (hiển thị nhỏ gọn) ===
\begin{tcolorbox}[
  colback=teacherblue!4,
  colframe=teacherblue!50,
  title={\bfseries Bộ Nâng Cao \& Cuốn Tổng Hợp (Quyển X -- XVII, Cuốn 1 -- 2)},
  coltitle=white,
  fonttitle=\bfseries,
  arc=6pt, boxrule=1pt,
...
\vspace{6pt}
\begin{center}
{\color{chalkgold}\rule{10cm}{1.5pt}}\\[4pt]
{\small\itshape\color{teacherblue!70} Bộ sách song ngữ Việt -- Anh dành cho giáo viên và học sinh}
\end{center}
\clearpage
