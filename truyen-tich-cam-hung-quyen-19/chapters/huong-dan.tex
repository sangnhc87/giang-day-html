...
\medskip
\textbf{\color{deepnavy}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{deepnavy!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{silver!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
