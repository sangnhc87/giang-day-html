...
Bộ sách <<Truyện Tích Cảm Hứng Song Ngữ>> gồm 24 quyển, mỗi quyển một chủ đề riêng. Quyển XIII này mang chủ đề: \textbf{trả lời thẳng những câu hỏi bị giữ trong im lặng}.
\textit{(The series ``Inspiring Bilingual Tales'' contains 24 volumes, each with its own theme. Volume XIII focuses on: \textbf{trả lời thẳng những câu hỏi bị giữ trong im lặng}.})
\end{truyen}
