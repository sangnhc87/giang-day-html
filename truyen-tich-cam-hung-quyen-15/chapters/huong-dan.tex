...
\smallskip
\textbf{\color{earthink}Ô Nâu~--- Câu Chuyện Chính (\textit{Main Story})}\\
...
\medskip
\textbf{\color{deepblue}Ô Xanh~--- Bài Học (\textit{Lesson Learned})}\\
...
\medskip
\textbf{\color{deepblue!60}Ô Xanh Nhạt~--- Tiếng Anh Ngắn (\textit{Easy English})}\\
...
\medskip
\textbf{\color{softcopper!80!black}Ô Vàng~--- Tự Học Nhanh (\textit{Quick Self-Study})}\\
